<?php
// /app/local/Rabot/Categorylimit/controllers/Adminhtml/Catalog/CategoryController.php
 
class Rabot_Categorylimit_Adminhtml_Catalog_CategoryController extends Mage_Adminhtml_Catalog_CategoryController
{
